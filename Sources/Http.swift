...
public final class http {
    ...
    public class func post(_ url: String, body: [String: Any]? = nil, completion: @escaping (JSON?) -> Void) {
...
fileprivate extension HTTP {
    @discardableResult
    class func post(_ url: String, body: [String: Any], callback: @escaping ClientRequest.Callback) {
